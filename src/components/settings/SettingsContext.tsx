import {
  ...
  import { defaultPreset, getPresets, presetsOption } from './BootSettings';
  import {
    ThemeModeValue,
    ThemeLayoutValue,
    ThemeStretchValue,
  ...
  export function SettingsProvider({ children }: SettingsProviderProps) {
    ...
    const [openNav, setOpenNav] = useState(defaultSettings.openNav);
    ...
    useEffect(() => {
      if (typeof window !== 'undefined') {
        ...
        const openNav = getCookie('openNav') || defaultSettings.openNav; 
        ...
        setOpenNav(openNav as ThemeOpenNavValue);
      }
    }, []);
    ...
    const onChangeDirectionByLang = useCallback((lang: string) => {
      ...
      // Nav
      const onChangeNavOpen = useCallback((open:boolean) => {
        const value = open;
        setOpenNav(value);
        setCookie('openNav', JSON.stringify(value));
      }, []);
